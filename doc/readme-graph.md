...
Список расширений файлов, в которых не следует искать комментарии. Например: `--exclude-extensions=png,zip`
...
Кодировка, в которой читаются файлы с комментариями и записываются документ и диаграмма. Для Windows может потребоваться указать `-e cp1251` для корректной работы с кириллицей.

По умолчанию: __utf-8__
...
Узлам можно задавать цвета на основе имени файла: `pattern = color`
...
Для встроенных цветовых схем:

* color_1 - синий
* color_2 - сине-зелёный
* color_3 - зелёный
...
Образцы шаблонов можно найти в директории Образец файла можно найти в директории [snippets](../snippets).
