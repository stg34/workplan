...
Кодировка, в которой читаются файлы с комментариями и записывается документ. Для Windows может потребоваться указать `-e cp1251` для корректной работы с кириллицей.
