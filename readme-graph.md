...
__[Пример документа](doc-examples/plan-graph-example.md)__

Диаграмма для этого документа (кликабельно):

![Diagram](doc-examples/plan-graph-example.png)
...
# DEV: Backender
```
![Diagram](doc-examples/dependeny-example.png)
...
![Diagram](doc-examples/dependeny-example-2.png)
...
Образец файла можно найти [тут](.plangraph.conf).
